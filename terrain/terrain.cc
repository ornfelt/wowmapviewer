...
void initFonts()
{
  ftex = loadTGA("../src/arial.tga", false);

  f16 = new Font(ftex, 256, 256, 16, "../src/arial.info");
  f24 = new Font(ftex, 256, 256, 24, "../src/arial.info");
  f32 = new Font(ftex, 256, 256, 32, "../src/arial.info");
}
